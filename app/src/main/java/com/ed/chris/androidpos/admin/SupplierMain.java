...
import com.ed.chris.androidpos.admin.updateclass.SupplierCreate;
...
public class SupplierMain extends NavigationLiveo implements OnItemClickListener {
    ...
    public void onInt(Bundle savedInstanceState) {
        ...
        mHelpLiveo.add(("Add Supplier"), R.drawable.productadd);
        mHelpLiveo.add(("View Suppliers"), R.drawable.productcategories);
        ...
        with(this) // default theme is dark
                ...
                .setOnClickFooter(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(SupplierMain.this);
                        ...
                        builder.setPositiveButton("Yes",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(SupplierMain.this, LoginForm.class);
    ...
    public void onItemClick(int position) {
        ...
        if (position == 0) {
            ...
            Intent intent = new Intent(this, SupplierCreate.class);
            startActivity(intent);
            ...
            setFragment(supplierMaintenanceFragment);
